    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        <div className="lg:col-span-3">
          <div className={`relative bg-slate-900 rounded-3xl overflow-hidden border border-slate-800 shadow-2xl transition-all duration-500 ${isFullscreen ? 'fixed inset-0 z-[60] !rounded-none !border-none' : 'aspect-video'}`}>
            <iframe 
              ...
              allow="fullscreen"
            />
            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center bg-slate-900/90 backdrop-blur-md px-4 py-2 rounded-xl border border-slate-700">
        ...
        <div className="space-y-8">
          <h3 className="text-xl font-bold text-white">Related Games</h3>
